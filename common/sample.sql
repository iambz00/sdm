...
('STS_BROKEN',  'GRP_STATUS', '고장', '고장 등 사용 불가 상태(기기 있음)', TRUE),
...
('VND_SAMSUNG', 'S6 Lite', 'SM-P610NZAEKOO', 'Snapdragon ? Gen 1', 9.0, 420300, 'OS_ANDROID','{"storage": "128GB", "ram": "8GB"}'),
('VND_SAMSUNG', 'S9 FE+', 'SM-X610', 'Snapdragon 778G', 12.4, 601287, 'OS_ANDROID', '{"storage": "64GB", "ram": "4GB"}'),
('VND_SAMSUNG', 'S10 FE', 'SM-X520N', 'Snapdragon 778G', 11.0, 720391, 'OS_ANDROID', '{"storage": "64GB", "ram": "4GB"}'),
('VND_FORU'   , 'L101', 'SM-X520N', 'MTK Helio P70', 10.4, 268000, 'OS_ANDROID', '{"storage": "64GB", "ram": "4GB"}'),
...
(2023, 'DIST_EDU_GEN', '2023년 서울 교육청 일반 보급', '2023년 서울시 교육청 관할 학교 대상 일반 보급 사업', '{"budget": "10억"}'),
(2024, 'DIST_EDU_SPEC', '2024년 부산 교육청 특별 보급', '2024년 부산시 교육청 관할 학교 대상 특별 보급 사업 (저소득층 지원)', '{"budget": "5억", "target": "저소득층"}');
